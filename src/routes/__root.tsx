...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Counting down to September 13, 2026." },
      { name: "author", content: "Samvit" },
      { property: "og:title", content: "silly countdown — Samvit & Himani" },
      { property: "og:description", content: "Counting down to September 13, 2026." },
